      ...
      <section id="hero" className="hs-hero-new" aria-label="Hero">
        ...
        <m.div className="hs-ticker-new" {...fadeUp(24, 1.15, 0.45)}>
          <div className="hs-ticker-inner-new">
            AUTONOMOUS PIPELINES · B2B OPERATIONS · N8N · MAKE · AI AGENTS · WORKFLOW AUTOMATION · ZERO MANUAL WORK · AUTONOMOUS PIPELINES · B2B OPERATIONS · N8N · MAKE · AI AGENTS · WORKFLOW AUTOMATION · ZERO MANUAL WORK · AUTONOMOUS PIPELINES · B2B OPERATIONS · N8N · MAKE · AI AGENTS · WORKFLOW AUTOMATION · ZERO MANUAL WORK · AUTONOMOUS PIPELINES · B2B OPERATIONS · N8N · MAKE · AI AGENTS · WORKFLOW AUTOMATION · ZERO MANUAL WORK · 
          </div>
        </m.div>
      </section>
