...
export function About() {
  ...
  return (
    <section id="about" className="min-h-screen py-20 md:py-32 border-b border-[#161616] bg-[#000000] overflow-hidden">
      <div className="container flex flex-col gap-16 md:gap-24">
        ...
        <div className="flex flex-col md:flex-row gap-20">
          ...
          >
            <div className="w-full aspect-[3/4] lg:h-[600px] relative border border-[#161616] overflow-hidden">
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <h3 className="font-display font-black tracking-tighter text-4xl md:text-[52px] text-[#ffffff] leading-none uppercase">
                We are builders.
              </h3>
            </div>

            <div className="flex flex-col gap-6 max-w-[600px]">
              <p className="font-sans text-[16px] md:text-[18px] text-[#ffffff] leading-[1.6]">
            ...
            <div className="flex flex-col gap-8 mt-4">
              {[
                ...
                <div key={i} className="flex flex-col gap-2 pl-4 border-l border-[#161616] hover:border-[#555555] transition-colors duration-300">
                  <span className="font-mono text-[10px] text-[#888888] uppercase tracking-widest">{principle.label}</span>
                  <span className="font-sans text-[15px] text-[#ffffff]">{principle.text}</span>
                </div>
              ))}
            </div>
          </m.div>
        ...
        <m.div 
          ...
          className="w-full border-t border-b border-[#161616] py-16 md:py-24 flex items-center justify-start mt-16 mb-16"
        >
          <h4 className="font-display font-black tracking-tighter text-3xl md:text-[64px] text-[#ffffff] text-left max-w-4xl leading-[0.9] uppercase pr-8">
            &quot;Build once.<br/>Own it.<br/>Scale globally.&quot;
          </h4>
        </m.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <m.div 
              ...
              className="flex flex-col gap-6 pb-8 border-b border-[#161616] hover:border-[#555555] transition-colors duration-300"
            >
              <item.Icon className="w-8 h-8 text-[#ffffff] stroke-[1.5]" />
